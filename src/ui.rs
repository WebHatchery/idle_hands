...
fn draw_footer() {
    ...
    draw_text_block(
        "Phase 0 foundation: this diagnostic harness proves toolkit UI, data, assets, events, notifications, camera helpers, and versioned save slots before the cabinet replaces it in Phase 1.",
        rect.x + 18.0,
        rect.y + 14.0,
        rect.w - 36.0,
        rect.h - 20.0,
