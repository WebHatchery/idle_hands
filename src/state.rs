...
pub struct AppState {
    ...
    pub sudoku_focus_open: bool,
    pub nonogram_focus_open: bool,
    pub tower_inspection: Option<usize>,
...
impl Default for AppState {
    fn default() -> Self {
        ...
        Self {
            ...
            sudoku_focus_open: false,
            nonogram_focus_open: false,
            tower_inspection: None,
