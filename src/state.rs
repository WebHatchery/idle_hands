...
impl GameId {
    ...
    pub fn subtitle(self) -> &'static str {
        match self {
            ...
            Self::Minesweeper => "Read the field",
            Self::Nonogram => "Paint the hidden picture",
            Self::Yahtzee => "Five dice, thirteen calls",
            Self::Reversi => "Turn the board",
            Self::LightsOut => "Settle the lights",
            Self::TicTacToe => "Three in a row",
            Self::MemoryPairs => "Find the pairs",
            Self::SlidingPuzzle => "Move the tiles",
            Self::Mastermind => "Read the color code",
            Self::Spider => "Build the webs",
            Self::WordSearch => "Find the hidden words",
            Self::Hangman => "Keep the word",
            Self::ConnectFour => "Drop the discs",
            Self::Checkers => "Turn the pieces",
            Self::PegSolitaire => "Leave one peg",
            Self::MahjongSolitaire => "Pair the tiles",
            Self::Snake => "Guide the coil",
            Self::Breakout => "Bounce the ball",
            Self::HigherLower => "Read the card",
            ...
            Self::Mancala => "Sow the stones",
            Self::Hanoi => "Move the disks",
            Self::NumberMatch => "Pair the numbers",
            Self::FloodIt => "Fill the field",
            Self::ColorSort => "Sort the colors",
            Self::Battleship => "Find the fleet",
            Self::WordGrid => "Solve the word",
            Self::PipeLoop => "Join the pipes",
            Self::MazeWalk => "Find the exit",
            Self::MatchThree => "Clear the colors",
            Self::Pyramid => "Pair the thirteen",
            Self::TriPeaks => "Clear the three peaks",
            Self::Nim => "Take the stones",
            Self::WordLadder => "Climb the words",
        }
    }
