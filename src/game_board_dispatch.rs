...
use super::game_board_actions::fresh_seed;
...
impl Game {
    ...
    fn apply_game_action_group_1(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_2(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_3(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_4(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_5(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_6(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_7(&mut self, action: &UiAction) -> bool {
        match action {
            UiAction::TowerUndo => {
    ...
    fn apply_game_action_group_8(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_9(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_10(&mut self, action: &UiAction) -> bool {
        match action {
            UiAction::FloodHint => {
    ...
    fn apply_game_action_group_11(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_12(&mut self, action: &UiAction) -> bool {
        match action {
    ...
    fn apply_game_action_group_13(&mut self, action: &UiAction) -> bool {
        match action {
