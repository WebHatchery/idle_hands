...
The shipped cabinet currently contains 44 playable games. The eight titles in
...
Pipe Loop, Maze Walk, Match Three, and Pyramid.
...
playable scope is the 44-game cabinet listed in Sections 1 and 11.
