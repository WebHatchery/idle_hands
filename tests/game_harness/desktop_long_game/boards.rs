...
use idle_hands::testing::games::battleship::Battleship;
use idle_hands::testing::games::checkers::Checkers;
use idle_hands::testing::games::color_sort::ColorSort;
use idle_hands::testing::games::connect_four::ConnectFour;
use idle_hands::testing::games::daily_dungeon::{DailyDungeon, DailyHint};
use idle_hands::testing::games::dots_boxes::DotsBoxes;
use idle_hands::testing::games::dungeon_sweeper::DungeonSweeper;
use idle_hands::testing::games::flood_it::FloodIt;
use idle_hands::testing::games::hanoi::Hanoi;
use idle_hands::testing::games::higher_lower::HigherLower;
use idle_hands::testing::games::mahjong_solitaire::MahjongSolitaire;
use idle_hands::testing::games::mancala::Mancala;
use idle_hands::testing::games::match_three::MatchThree;
use idle_hands::testing::games::maze_walk::MazeWalk;
use idle_hands::testing::games::number_match::NumberMatch;
use idle_hands::testing::games::one_room_roguelike::{OneRoomRoguelike, RogueHint};
use idle_hands::testing::games::peg_solitaire::PegSolitaire;
use idle_hands::testing::games::pipe_loop::PipeLoop;
use idle_hands::testing::games::reversi::{AiLevel as ReversiAi, Reversi};
use idle_hands::testing::games::sokoban::Sokoban;
use idle_hands::testing::games::tic_tac_toe::TicTacToe;
use idle_hands::testing::games::tiny_tower_defence::{TinyTowerDefence, TowerHint};
...
fn nim() {
    let mut game = idle_hands::testing::games::nim::Nim::new(SESSION_SEED);
    let mut moves = 0;
    for round in 0..24 {
