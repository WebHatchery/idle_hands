...
use idle_hands::testing::games::blackjack::{Blackjack, BlackjackHint};
use idle_hands::testing::games::freecell::FreeCell;
use idle_hands::testing::games::klondike_golf::KlondikeGolf;
use idle_hands::testing::games::pyramid::Pyramid;
use idle_hands::testing::games::solitaire::Solitaire;
use idle_hands::testing::games::spider::Spider;
use idle_hands::testing::games::spider_solitaire::is_run as is_spider_solitaire_run;
use idle_hands::testing::games::spider_solitaire::SpiderSolitaire;
use idle_hands::testing::games::tri_peaks::TriPeaks;
